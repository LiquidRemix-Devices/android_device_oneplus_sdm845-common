...

{
	...
	write devices/system/cpu/cpu0/cpufreq/pixel_smurfutil/up_rate_limit_us 1000;
	write devices/system/cpu/cpu0/cpufreq/pixel_smurfutil/down_rate_limit_us 10000;
	write devices/system/cpu/cpu4/cpufreq/pixel_smurfutil/up_rate_limit_us 1000;
	write devices/system/cpu/cpu4/cpufreq/pixel_smurfutil/down_rate_limit_us 10000;
...
write /sys/module/cpu_input_boost/parameters/input_stune_boost_offset 15;
write /sys/module/cpu_input_boost/parameters/flex_stune_boost_offset 10;
write /sys/module/cpu_input_boost/parameters/max_stune_boost_offset 30;
	write /sys/devices/system/cpu/cpufreq/policy0/scaling_governor pixel_smurfutil;
